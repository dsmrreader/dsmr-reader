...
- ``Fixed``: Server error Energy Contracts [`#1128 <https://github.com/dennissiemensma/dsmr-reader/issues/1128>`_]
...
- ``Added``: Vervanger voor Status endpoint (`/api/v2/application/monitoring`) [`#1086 <https://github.com/dennissiemensma/dsmr-reader/issues/1086>`_]
...
- ``Fixed``: Datalogger altijd opnieuw laten verbinden [`#1114 <https://github.com/dennissiemensma/dsmr-reader/issues/1114>`_]
