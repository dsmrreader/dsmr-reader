        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Create a backup of your data daily. Stored locally, but can be exported using Dropbox.",
                        verbose_name="Backup daily",
                    ),
                ),
                (
                    "compress",
                    models.BooleanField(
                        default=True,
                        help_text="Create backups in compressed (gzip) format, saving a significant amount of disk space.",
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        default=None,
                        blank=True,
                        help_text='Timestamp of latest backup created. Automatically updated by application. Please note that the application will ignore the "backup_time" setting the first time used.',
                        verbose_name="Latest backup",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.DateTimeField(
                        ...
                        default=None,
                        blank=True,
                        help_text="Timestamp of latest sync with Dropbox. Automatically updated by application.",
