        ...
        (
            None, {
                ...
                'description': _(
                    ...
                    'hedocs.io/nl/v4/faq.html#how-do-i-restore-a-database-backup">FAQ in documentation</a>.'
                )
            }
        ),
        (
        ...
        (
            None, {
                ...
                'description': _(
                    ...
                    'Dropbox can be found here: <a href="https://dsmr-reader.readthedocs.io/nl/v4/admin/'
