...
class TestToday(APIv2TestCase):
    ...
    def test_get(self, now_mock):
        ...
        self.assertEqual(
            result["electricity_merged"],
            result["electricity1"] + result["electricity2"],
        )
        self.assertEqual(
            result["electricity_returned_merged"],
            result["electricity1_returned"] + result["electricity2_returned"],
        )
...
class TestElectricity(APIv2TestCase):
    ...
    def test_get(self):
        ...
        resultset = self._request(
            ...
            data={"read_at__lte": "2015-12-12 02:00:00", "limit": 100},
        )
...
class TestGas(APIv2TestCase):
    ...
    def test_get(self):
        ...
        resultset = self._request(
            "gas-consumption",
            data={"read_at__lte": "2015-12-13 00:00:00", "limit": 100},
        )
