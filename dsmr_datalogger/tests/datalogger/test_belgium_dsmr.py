...
class TestDatalogger(InterceptStdoutMixin, TestCase):
    ...
    def test_reading_values(self, now_mock):
        ...
        self.assertEqual(reading.electricity_delivered_1, Decimal('338.681'))
        self.assertEqual(reading.electricity_returned_1, Decimal('0.425'))
        self.assertEqual(reading.electricity_delivered_2, Decimal('260.129'))
        self.assertEqual(reading.electricity_returned_2, Decimal('0.010'))
