    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Whether we should track the P1 port on your smartmeter. Almost every feature inside this project requires this to be enabled. However, it might be disabled temporarily due to technical reasons, such as data migrations.",
                        verbose_name="Poll P1 port",
                    ),
                ),
                (
                    "baud_rate",
                    models.IntegerField(
                        default=115200,
                        help_text="BAUD rate used for Smartmeter. 115200 for DSMR v4, 9600 for older versions",
                ...
                (
                    ...
                    models.CharField(
                        max_length=196,
                        help_text="COM-port connected to Smartmeter.",
                        default="/dev/ttyUSB0",
                        verbose_name="COM-port",
                    ),
                ),
                (
                    "track_meter_statistics",
                    models.BooleanField(
                        default=True,
                        help_text="Whether we should track any extra statistics sent by the meter, such as the number of power failures of voltage dips. Data is not required for core features.",
                        verbose_name="Track meter statistics",
                    ),
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=3,
                        max_digits=9,
                        help_text="Meter Reading electricity delivered to client (Dutch users: low tariff) in 0,001 kWh",
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        decimal_places=3,
                        max_digits=9,
                        help_text="Meter Reading electricity delivered by client (Dutch users: low tariff) in 0,001 kWh",
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        decimal_places=3,
                        max_digits=9,
                        help_text="Meter Reading electricity delivered to client (normal tariff) in 0,001 kWh",
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        decimal_places=3,
                        max_digits=9,
                        help_text="Meter Reading electricity delivered by client (normal tariff) in 0,001 kWh",
                    ),
                ),
                (
                    "electricity_tariff",
                    models.IntegerField(
                        help_text="Tariff indicator electricity. The tariff indicator can be used to switch tariff dependent loads e.g boilers. This is responsibility of the P1 user. Note: Tariff code 1 is used for low tariff and tariff code 2 is used for normal tariff."
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        decimal_places=3,
                        max_digits=9,
                        help_text="Actual electricity power delivered (+P) in 1 Watt resolution",
                    ),
                ),
                (
                    ...
                    models.DecimalField(
                        decimal_places=3,
                        max_digits=9,
                        help_text="Actual electricity power received (-P) in 1 Watt resolution",
                    ),
                ),
                (
                    "power_failure_count",
                ...
                (
                    ...
                    models.DateTimeField(help_text="Last hourly reading timestamp"),
                ),
                (
                    ...
                    models.DecimalField(
                        decimal_places=3,
                        max_digits=9,
                        help_text="Last hourly value delivered to client",
                    ),
                ),
                (
                    "processed",
                    models.BooleanField(
                        default=False,
                        db_index=True,
                        help_text="Whether this reading has been processed for merging into statistics",
                    ),
                ),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.IntegerField(
                ...
                choices=[(4, "DSMR version 4"), (3, "DSMR version 2/3")],
            ),
        ),
        migrations.AlterField(
            model_name="dsmrreading",
        ...
        migrations.AlterField(
            ...
            field=models.DateTimeField(
                default=None, help_text="Last hourly reading timestamp", null=True
            ),
        ),
    ]
