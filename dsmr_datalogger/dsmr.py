DSMR_MAPPING = {
    ...
    # electricity total
    '1-0:1.8.0': 'active_energy_delivered',
    '1-0:2.8.0': 'active_energy_returned',
    '1-0:3.8.0': 'reactive_energy_delivered',
    '1-0:4.8.0': 'reactive_energy_returned',

    # electricity per tariff
    ...
    '1-0:23.7.0': 'reactive_power_delivered_l1',
    '1-0:43.7.0': 'reactive_power_delivered_l2',
    '1-0:63.7.0': 'reactive_power_delivered_l3',
    '1-0:24.7.0': 'reactive_power_returned_l1',
    '1-0:44.7.0': 'reactive_power_returned_l2',
    '1-0:64.7.0': 'reactive_power_returned_l3',

    # electric current per phase
    '1-0:31.7.0': 'electric_current_l1',
    '1-0:51.7.0': 'electric_current_l2',
    '1-0:71.7.0': 'electric_current_l3',
