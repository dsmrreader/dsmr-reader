...
# DSMR-reader
Self-hosted DSMR-protocol reader, telegram data storage and energy consumption visualizer.
Can be used for reading the smart meter DSMR (Dutch Smart Meter Requirements) P1 port yourself at your home. 


## Prerequisites
You will need hardware that can run Linux software and a cable (or other connection) to your smart meter.


## License
Always free for [non-commercial use](./LICENSE.md).


## Docs
Check out [the documentation](https://dsmr-reader.readthedocs.io/en/v6/) for more information.
Powered by the [containers](https://github.com/xirixiz/dsmr-reader-docker) of [@Xirixiz](https://github.com/xirixiz).
...
[Check out the documentation for more screenshots](https://dsmr-reader.readthedocs.io/en/v6/reference/about/#screenshots)
