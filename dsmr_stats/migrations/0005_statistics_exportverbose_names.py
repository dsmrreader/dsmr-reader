...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterField(
            ...
            field=models.DecimalField(decimal_places=1, verbose_name='Average temperature', null=True, default=None, max_digits=4),
        ),
        migrations.AlterField(
            model_name='daystatistics',
            name='day',
        ...
        migrations.AlterField(
            model_name='daystatistics',
            name='gas',
            field=models.DecimalField(decimal_places=3, verbose_name='Gas', null=True, default=None, max_digits=9),
        ),
        migrations.AlterField(
            model_name='daystatistics',
            name='gas_cost',
