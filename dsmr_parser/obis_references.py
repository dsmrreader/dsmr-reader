...
BELGIUM_ELECTRICITY_USED_TARIFF_1 = r'\d-\d:1\.8\.2.+?\r\n'  # Totale afname van energie in kWh nachttarief
BELGIUM_ELECTRICITY_USED_TARIFF_2 = r'\d-\d:1\.8\.1.+?\r\n'  # 1.8.1 Totale afname van energie in kWh dagtarief
