...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            ...
            options={'default_permissions': (), 'verbose_name': 'Electricity consumption'},
        ),
        migrations.AlterModelOptions(
            name='gasconsumption',
        ...
        migrations.AlterField(
            ...
            field=models.DecimalField(decimal_places=3, help_text='Delivered value, based on the previous reading', max_digits=9),
        ),
        migrations.AlterField(
            model_name='gasconsumption',
            name='delivered',
