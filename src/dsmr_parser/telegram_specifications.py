...
V4 = {
    ...
    "objects": [
        ...
        },
        {
            ...
            "value_parser": ProfileGenericParser(BUFFER_TYPES, PG_HEAD_PARSERS, PG_UNIDENTIFIED_BUFFERTYPE_PARSERS),
        ...
        },
        {
            ...
            "value_parser": MBusParser(ValueParser(timestamp), ValueParser(Decimal)),
