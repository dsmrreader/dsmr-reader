        ...
        (
            None,
            {
                ...
                "description": _(
                    ...
                    'thedocs.io/en/v5/how-to/database/postgresql-restore-backup.html">in documentation</a>.'
                ),
            },
        ),
        (
            _("Advanced"),
            {
                "fields": ["file_name", "folder", "compression_level"],
            },
        ),
    )
