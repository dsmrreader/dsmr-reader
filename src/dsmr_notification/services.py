...
from dsmr_notification.models.settings import (
    NotificationSetting,
...
def create_consumption_message(day_statistics: DayStatistics) -> str:  # noqa: C901
    ...
    if capabilities[Capability.COSTS] and day_statistics.total_cost is not None:
        ...
        message += _("Total costs") + ": € {}".format(formats.number_format(total_cost))
    ...
    DATA_FORMAT = {
        ...
        NotificationSetting.NOTIFICATION_TELEGRAM: {
            "url": "{}{}/sendMessage".format(
                NotificationSetting.TELEGRAM_API_URL,
...
def check_status() -> None:
    ...
    with translation.override(language=BackendSettings.get_solo().language):
        send_notification(
            str(
                _(
                    "It has been over {} minutes since the last reading received. Please check your datalogger.".format(
