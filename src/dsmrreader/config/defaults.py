...
DSMRREADER_BACKEND_HIBERNATE = config("DSMRREADER_BACKEND_HIBERNATE", cast=bool, default=False)

DSMRREADER_DECIMAL_SIZE_FORMATTING = config("DSMRREADER_DECIMAL_SIZE_FORMATTING", cast=bool, default=True)
