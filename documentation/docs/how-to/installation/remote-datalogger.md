...
You can enable the API and view/edit the API key used in the configuration.
...
Create a new file `/home/dsmr/dsmr_datalogger_api_client.py` with the following contents: [dsmr_datalogger_api_client.py on GitHub](https://github.com/dsmrreader/dsmr-reader/blob/v5/dsmr_datalogger/scripts/dsmr_datalogger_api_client.py)
