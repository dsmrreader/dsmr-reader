...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='influxdbintegrationsettings',
            name='bucket',
            field=models.CharField(default='dsmrreader_measurements',
                                   help_text='The name of the bucket used in InfluxDB.',
                                   max_length=64, verbose_name='InfluxDB bucket'),
        ),
        migrations.AddField(
            model_name='influxdbintegrationsettings',
            name='api_token',
            field=models.CharField(default='', help_text='The API token to use.', max_length=64, verbose_name='InfluxDB API token'),
        ),
        migrations.AddField(
            model_name='influxdbintegrationsettings',
            name='organization',
            field=models.CharField(default='', help_text='The organization to use.', max_length=64, verbose_name='InfluxDB organization'),
        ),
