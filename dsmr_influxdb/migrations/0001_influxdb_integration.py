    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('database', models.CharField(default='dsmrreader_dsmr_reading', help_text='The name of the database used in InfluxDB.', max_length=64, verbose_name='InfluxDB database')),
