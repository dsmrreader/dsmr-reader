    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('database', models.CharField(help_text='The name of the database used in InfluxDB.', max_length=64, verbose_name='InfluxDB database')),
                ...
                ('restart_required', models.BooleanField(default=False, help_text='Whether the process requires a restart, forcing the connection to be reset.', verbose_name='Restart required')),
            ],
            options={
