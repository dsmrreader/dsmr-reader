    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=3,
                        help_text="Actual value delivered to client, since the last hour",
                        max_digits=9,
                    ),
                ),
            ],
        ...
        migrations.AddField(
            ...
            field=models.BooleanField(
                default=False,
                help_text="Whether this reading has been processed for individual splitting",
            ),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "electricity_1_price",
                    models.DecimalField(decimal_places=5, max_digits=11),
                ),
                (
                    "electricity_2_price",
                    models.DecimalField(decimal_places=5, max_digits=11),
        ...
        migrations.AddField(
            ...
            field=models.CharField(
                null=True,
                max_length=255,
                help_text="For your own reference, i.e. your supplier name",
                blank=True,
            ),
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "compactor_grouping_type",
                    models.IntegerField(
                        default=2,
                        help_text="Electricity readings are read every 10 seconds. We can group those for you.",
                        choices=[
                            (1, "By reading (every 10 seconds)"),
                            (2, "By minute"),
                        ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=True,
                        help_text="Whether we should track trends by storing daily consumption summaries.",
                        verbose_name="Track trends",
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(decimal_places=3, max_digits=9),
                ),
                (
