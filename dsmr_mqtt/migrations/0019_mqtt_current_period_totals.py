    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('enabled', models.BooleanField(default=False, help_text='Whether the period totals are sent to the broker, in JSON format.', verbose_name='Enabled')),
                ('topic', models.CharField(default='dsmr/current-period', help_text='The topic to send the JSON formatted message to.', max_length=256, verbose_name='Topic path')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('enabled', models.BooleanField(default=False, help_text='Whether period totals are sent to the broker, having each field sent to a different topic.', verbose_name='Enabled')),
